        ...
        <div className="p-6 space-y-6">
            ...
            <button
              ...
              className={cn(
                ...
                visibility === 'private' 
                  ...
                  : "bg-surface border-subtle text-dim hover:border-strong"
              )}
            >
              <Lock size={20} />
              ...
              >
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    className="w-full bg-surface border border-subtle px-4 py-3 rounded-lg text-main font-mono text-[11px] focus:outline-none focus:border-brand transition-all appearance-none"
                  >
          ...
          <div className="pt-4">
            <button
               ...
               className="w-full py-4 bg-brand text-[var(--bg-deep)] text-[11px] font-black uppercase tracking-[0.2em] rounded-xl hover:shadow-[0_0_20px_rgba(62,207,142,0.3)] transition-all shadow-lg active:scale-95 flex items-center justify-center gap-2"
            >
