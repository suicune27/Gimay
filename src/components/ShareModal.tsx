  ...
  return (
    <div className="fixed inset-0 z-[500] flex items-center justify-center p-4">
      ...
      <motion.div
        ...
        className="relative w-full max-w-md bg-header border border-subtle rounded-2xl shadow-2xl overflow-hidden"
      >
        ...
        <div className="p-6 space-y-6">
            ...
            <button
              ...
              className={cn(
                ...
                visibility === 'private' 
                  ...
                  : "bg-input border-subtle text-dim hover:border-strong"
              )}
            >
              <Lock size={20} />
            ...
            {visibility === 'team' && (
              ...
              >
                <div className="space-y-2">
                  <label className="text-[9px] font-black text-dim uppercase tracking-widest">Select Deployment Unit</label>
                  <select
                    value={teamId || ''}
                    onChange={(e) => setTeamId(e.target.value)}
                    className="w-full bg-input border border-subtle px-4 py-3 rounded-lg text-white font-mono text-[11px] focus:outline-none focus:border-[var(--brand)] transition-all appearance-none"
                  >
                ...
                <div className="space-y-2">
                  <label className="text-[9px] font-black text-dim uppercase tracking-widest">Operational Role</label>
                  ...
                  <p className="text-[8px] text-dim uppercase tracking-tighter mt-2 text-center">
          ...
          <div className="pt-4">
            <button
               ...
               className="w-full py-4 bg-[var(--brand)] text-[var(--bg-deep)] text-[11px] font-black uppercase tracking-[0.2em] rounded-xl hover:shadow-[0_0_20px_rgba(var(--brand-rgb),0.3)] transition-all shadow-lg active:scale-95 flex items-center justify-center gap-2"
            >
