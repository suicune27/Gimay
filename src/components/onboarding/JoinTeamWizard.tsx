  ...
  return (
    ...
    >
      ...
      <div className="space-y-6">
        <div className="p-4 rounded-xl bg-[var(--brand)]/10 border border-[var(--brand)]/20 flex gap-4 items-center mb-2">
          <div className="w-12 h-12 rounded-lg bg-[var(--brand)]/20 flex items-center justify-center shrink-0">
            <CheckCircle2 size={24} className="text-[var(--brand)]" />
          </div>
          <div>
        ...
        <div>
          ...
          <input
            ...
            maxLength={24}
            className="w-full px-4 py-3 bg-elevated border border-subtle rounded-lg text-white placeholder:text-dim focus:border-[var(--brand)] focus:outline-none transition-all font-mono tracking-wider text-center"
          />
        ...
        <button
          ...
          className="w-full px-4 py-4 bg-[var(--brand)] text-[var(--text-on-brand)] font-black rounded-lg hover:shadow-[0_0_20px_rgba(var(--brand-rgb),0.4)] transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-lg uppercase tracking-wider"
        >
