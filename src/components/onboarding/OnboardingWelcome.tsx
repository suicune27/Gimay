  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="mb-6"
      >
        <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-[var(--brand)] to-[#2BA86D] flex items-center justify-center shadow-[0_0_30px_rgba(var(--brand-rgb),0.3)]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 w-full">
        {[
          ...
          <motion.div
            ...
            className="p-4 rounded-lg bg-elevated border border-subtle hover:border-[var(--brand)]/30 transition-all"
          >
            <feature.icon size={24} className="text-[var(--brand)] mx-auto mb-2" />
      ...
      <motion.button
        ...
        className="px-8 py-3 bg-[var(--brand)] text-[var(--text-on-brand)] font-bold rounded-lg hover:shadow-[0_0_20px_rgba(var(--brand-rgb),0.4)] transition-all uppercase text-sm tracking-widest"
      >
        Get Started
      </motion.button>
