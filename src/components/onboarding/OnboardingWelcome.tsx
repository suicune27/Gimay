...
export const OnboardingWelcome: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Title */}
      <h1 className="text-4xl font-black text-main mb-3 tracking-tight">
        Welcome to Gimay
      </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 w-full">
        {[
          ...
          <motion.div
            ...
            className="p-4 rounded-lg bg-elevated border border-subtle hover:border-brand/30 transition-all"
          >
            <feature.icon size={24} className="text-brand mx-auto mb-2" />
            <p className="text-sm font-bold text-main mb-1">{feature.label}</p>
      ...
      <motion.button
        ...
        className="px-8 py-3 bg-brand text-[var(--text-on-brand)] font-bold rounded-lg hover:shadow-[0_0_20px_rgba(62,207,142,0.4)] transition-all uppercase text-sm tracking-widest"
      >
        Get Started
      </motion.button>
