...
class WorkerPool {
  ...
  static clear() {
    ...
    // Safety: Invoke onTerminate on each active worker to resolve their pending SandboxRunner promises.
    // This allows V8 to cleanly garbage-collect the execution context closures.
